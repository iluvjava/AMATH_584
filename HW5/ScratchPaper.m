...
%% RAYLEIGH QUOTIENT INVERSE ITERATIONS WITH RANDOM SYMMETRIC MATRICES. 
clear variables;
A = RandomSymmetricMatrixNormal(10);
n = 10;
...
%% POWER ITERATIONS RANDOM NON-SYMMETRIC MATRICES. 
...
%% RAYLEIGH QUOTIENT INVERSE POWER ITERATIONS FOR NON SYMMETRIC RANDOM MATRICES. 
clear variables; clc;
A = randn(10);
n = 20;
[EigenValue, EigenVector, Lambda, EigenSpace] = RQuotientIteration(A, n);
